  ...
  return (
    <main className="min-h-screen bg-[#061f2d] text-white lg:grid lg:grid-cols-[1.1fr_.9fr]">
      <section className="relative hidden min-h-screen overflow-hidden lg:block">
        <Image
          src="/media/hero-products.jpg"
          alt="Dingsheng Energy industrial facility"
          fill
        ...
        <div className="absolute bottom-16 left-16 max-w-xl">
          <div className="text-xs font-black uppercase tracking-[.2em] text-[#5ce0ad]">
            Dingsheng Control
            Center
          </div>
      ...
      <section className="flex min-h-screen items-center justify-center px-6 py-16">
        <div className="w-full max-w-md rounded-2xl border border-white/10 bg-white/[.055] p-7 shadow-2xl backdrop-blur-xl md:p-9">
          <Image
            ...
            width={100}
            height={79}
            alt="Dingsheng Energy"
            className="h-auto w-20 object-contain"
            priority
          />

          <div className="mt-8 text-xs font-black uppercase tracking-[.18em] text-[#5ce0ad]">
            Administrator
            Access
          </div>
          ...
          >
            <label
              className="text-xs font-extrabold text-white/70"
              htmlFor="password"
            >
              Administrator
              password
            ...
            {error ? (
              <div
                role="alert"
                className="mt-3 rounded-md border border-red-400/20 bg-red-500/10 px-3 py-2 text-xs leading-5 text-red-100"
              >
                {error}
              </div>
            ) : null}
            ...
            <button
              ...
              className="mt-5 flex h-12 w-full items-center justify-center rounded-md bg-[#0a9c63] text-xs font-black uppercase tracking-[.12em] transition hover:bg-[#087f52] disabled:cursor-not-allowed disabled:opacity-60"
            >
              {loading
                ? "Signing in..."
                : "Open Control Center →"}
