...
const coreSolutions = [
  [
    ...
    "International sourcing, import/export, vessel chartering, port coordination and distribution.",
    "/lpg-trading",
  ],
  [
    "gear",
    "Engineering & EPC",
    "Plant engineering, installation, testing, commissioning, reticulation and project support.",
    "/services",
  ],
  [
    "box",
    "Equipment Supply",
    "Storage tanks, filling machinery, pumps, compressors, vaporizers, measuring equipment and accessories.",
    "/products",
  ],
  [
    "wrench",
    "After-Sales Support",
    "Inspection, maintenance, troubleshooting, repair and servicing of LPG machinery.",
    "/services/machinery-servicing",
  ],
] as const;

/*
 * These images are used specifically on the homepage.
 * Category images used elsewhere in the catalogue remain unchanged.
 */
const homeCategoryImages: Record<
  string,
  string
> = {
  "lpg-filling-plant":
    "/media/home/lpg-filling-plant.png",

  "lpg-transport-distribution":
    "/media/home/transport-distribution.png",

  "autogas-refueling-station":
    "/media/home/autogas-station.png",

  "industrial-lpg-solutions":
    "/media/home/industrial-lpg.jpg",
};
    ...
    <PublicShell>
      <section className="relative min-h-[690px] overflow-hidden bg-[#061e2b] text-white">
        <Image
          ...
          alt="Dingsheng Energy LPG production, storage, transportation and distribution network"
          fill
          priority
          sizes="100vw"
        ...
        <div className="container-shell relative z-10 flex min-h-[690px] items-center pb-36 pt-24">
          <div className="max-w-[770px]">
            <div className="flex items-center gap-3 text-xs font-black uppercase tracking-[.18em] text-[#4dd8a1]">
              ...
              Global LPG Trading, Engineering
            ...
            <div className="grid overflow-hidden border border-white/10 bg-[#071f2c]/92 backdrop-blur-md md:grid-cols-4">
              {[
                [
                  "shield",
                  "Safety First",
                  "International standards & careful engineering",
                ],
                [
                  "globe",
                  "Global Supply",
                ...
                [
                  "gear",
                  "Engineering",
                  "End-to-end LPG project capability",
                ],
                [
                  "handshake",
                  "Trusted Partner",
        ...
        <div className="container-shell">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="mt-4 text-sm leading-7 text-[#687b84]">
              From trading and logistics to
              engineering, equipment supply
              and after-sales service,
              Dingsheng Energy supports the
              LPG value chain from sourcing
              to operation.
            </p>
          </div>
            ...
            {coreSolutions.map(
              (
                ...
                <Link
                  href={href}
                  key={title}
                  className="card card-hover relative min-h-[270px] p-6"
                >
                  ...
                  <div className="absolute bottom-6 left-6 text-xs font-extrabold text-[#0a9c63]">
                    Learn more →
                  </div>
                </Link>
              ),
      ...
      <section className="section dark-section">
        <div className="container-shell">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <h2 className="h2 mt-3">
              Equipment for Every LPG
              Application
            </h2>

            <p className="mt-4 text-sm leading-7 text-white/60">
              Four integrated product systems
              organize equipment around real
              plant, transport, autogas and
          ...
          <div className="flex flex-wrap items-end justify-between gap-5">
            <div>
              ...
              <p className="mt-3 max-w-2xl text-sm leading-7 text-[#687b84]">
                ...
                public while commercial pricing
                remains protected for approved
                dealers.
              </p>
            </div>
        ...
        <div className="container-shell grid-2 items-center">
          <div>
            ...
            <p className="lead mt-5">
              ...
              commissioning, reticulation and
              servicing across LPG
              applications.
            </p>
          ...
          <div className="relative min-h-[470px] overflow-hidden rounded-2xl bg-[#071f2c] shadow-xl">
            <Image
              src="/media/home/epc-services.jpg"
              alt="LPG engineering, equipment procurement and pipeline installation"
              fill
              sizes="(max-width: 1024px) 100vw, 50vw"
              className="object-cover object-center"
            />

            <div className="absolute inset-0 bg-gradient-to-t from-[#071f2c]/85 via-[#071f2c]/10 to-transparent" />
        ...
        <div className="container-shell grid-2 items-center">
          <div className="relative min-h-[430px] overflow-hidden rounded-2xl bg-[#061e2b] shadow-xl">
            <Image
              ...
              alt="International LPG shipping and road distribution"
              fill
              sizes="(max-width: 1024px) 100vw, 50vw"
              className="object-cover object-center"
            />
          ...
          <div>
            ...
            <p className="mt-5 text-lg leading-8 text-white/68">
              International LPG sourcing,
              import/export, vessel chartering,
              port coordination, loading,
              unloading and domestic
              distribution.
            </p>
      ...
      <section className="section bg-white">
        <div className="container-shell">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <h2 className="h2 mt-3">
              Energy Solutions Across Critical
              Industries
            </h2>
          </div>

          <div className="mt-9 grid grid-cols-2 border-l border-t border-[#e0e9e5] sm:grid-cols-3 md:grid-cols-5 lg:grid-cols-10">
            {industries.map(
              ([slug, name]) => (
                <Link
                  key={slug}
                  href={`/industries/${slug}`}
                  className="flex min-h-[125px] flex-col items-center justify-center border-b border-r border-[#e0e9e5] px-3 text-center transition hover:bg-[#f3faf6]"
                >
                  <Icon
                    name="factory"
                  ...
                  <span className="mt-3 text-xs font-bold leading-5">
                    {name}
                  </span>
                </Link>
              ),
      ...
      <section className="section dark-section">
        <div className="container-shell grid-2 items-center">
          <div>
            ...
            <h2 className="h2 mt-3">
              Commercial Access for Approved
              Dealers
            </h2>

            <p className="mt-5 text-sm leading-7 text-white/62">
              Secure access to protected
              pricing, RFQs, orders and
              technical resources.
            </p>
      ...
      <section className="section-sm bg-white">
        <div className="container-shell">
          <Callout
            title="Planning an LPG Project?"
            copy="Talk with Dingsheng about equipment, EPC, LPG trading or complete project requirements."
          />
        </div>
      </section>
    </PublicShell>
